...
import 'package:univents_flutter_application/dashboard.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                const Align(
                    ...
                    child: Text('Username', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 23, color: Color.fromARGB(255, 33, 13, 120)))),
                TextField(
                ...
                const Align(
                    alignment: Alignment.centerLeft,
                    child: Text('Password', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 23, color: Color.fromARGB(255, 33, 13, 120)))),
                TextField(
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: const Text(
                      'Forgot Password?',
                      style: TextStyle(color: Color.fromARGB(255, 33, 13, 120),),
                      ),
                    ),
                  ],
                ),
              ...
              SizedBox(
                ...
                const SizedBox(height: 10),
                const Text('Or', style: TextStyle(fontSize: 25, color: Color.fromARGB(255, 33, 13, 120))),
                const SizedBox(height: 10),
                ElevatedButton.icon(
